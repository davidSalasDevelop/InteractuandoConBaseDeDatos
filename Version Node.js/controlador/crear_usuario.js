    ...
    Usuario.find({}, (err, usuarios) => {
      if (err) {
        ...
        if (usuarios.length <= 0) {
			...
			nuevoUsuario1.nombre = 'David Estuardo Salas'
			nuevoUsuario1.email = 'david96develop@gmail.com'
			nuevoUsuario1.clave = 'david123456'
			...
			nuevoUsuario2.nombre = 'David Monzon'
			nuevoUsuario2.email = 'davidmsnsalas@hotmail.com'
			nuevoUsuario2.clave = 'david9696'
